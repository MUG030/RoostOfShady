...
{
    public class CardDemo : VisualElement
    {
        ...
        public new class UxmlFactory : UxmlFactory<CardDemo, UxmlTraits> { }
        ...
        public CardDemo()
        {
            ...
            m_description = container.Q<Label>("Dexcription");
            m_thumbnail = container.Q<VisualElement>("Thumbnail");

            var card = container.Q<VisualElement>("Root");
            card.AddManipulator(new Clickable(() => Debug.Log("Clicked!!")));
        }
    }
}
